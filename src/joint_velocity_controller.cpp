...
JointVelocityController::JointVelocityController(ros::NodeHandle* nh, ros::NodeHandle* pnh, std::string robot_ip, bool set_load):
...
void JointVelocityController::initialize_control_gains(){
