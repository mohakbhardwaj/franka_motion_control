...
JointPositionController::JointPositionController(ros::NodeHandle* nodehandle):nh_(*nodehandle)
{ // constructor
...
//     state_publisher_ = nh_.advertise<sensor_msgs::JointState>("exampleMinimalPubTopic", 1, true); 
...
int main(int argc, char** argv) 
{
    ...
    JointPositionController JointPositionController(&nh);  //instantiate an JointPositionController object and pass in pointer to nodehandle for constructor to use
