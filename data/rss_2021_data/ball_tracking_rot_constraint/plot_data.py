...
# sns.set_theme()
data = np.load('./rot_constraint_1_working.npz')
...
fig2.savefig('franka_real_rot_constraint_xyz_response.pdf', dpi=600, bbox_inches='tight')
fig1.savefig('franka_real_rot_constraint_joint_response.pdf', dpi=600, bbox_inches='tight')
fig3.savefig('franka_real_rot_constraint_quat_response.pdf', dpi=600, bbox_inches='tight')
fig4.savefig('franka_real_rot_constraint_ee_error.pdf', dpi=600, bbox_inches='tight')
fig5.savefig('franka_real_rot_constraint_quat_eror.pdf', dpi=600, bbox_inches='tight')


#Calculate average and median quaternion erors
avg_error_quat = np.average(ee_quat_error)
med_error_quat = np.median(ee_quat_error)
